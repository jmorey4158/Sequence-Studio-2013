...
{
    [Cmdlet(VerbsCommon.Get, "ContiguousORFList")]
    public class GetContiguousORFListCmdlt : PSCmdlet
    {
        #region Properties
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                WriteObject(ORFMethods.GetContiguousORFList((DNA)_seqObj, _len));
            }
            else if (this.ParameterSetName == "String")
            {
                WriteObject(ORFMethods.GetContiguousORFList( new DNA(Guid.NewGuid(), "", "", "", "", "", _seqStr), _len));
            }
        }
