...
{
    [Cmdlet(VerbsCommon.Get, "CodonPercentage")]
    public class GetCodonPercentageCmdlt : PSCmdlet
    {
        #region Membmers
        ...
        protected override void ProcessRecord()
        {
            if (this.ParameterSetName == "Object")
            {
                ...
                {
                    WriteObject(DnaMethods.CodonPercentage(((DNA)_seqObj).Sequence));
                }
                else if (_seqObj.GetType() == typeof(RNA))
                {
                    WriteObject(DnaMethods.CodonPercentage(((RNA)_seqObj).Sequence));
                }
            ...
            else if (this.ParameterSetName == "String")
            {
                ...
                {
                    WriteObject(DnaMethods.CodonPercentage(_seqStr));
                }
